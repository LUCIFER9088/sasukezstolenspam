...
RIZ_PIC = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/file/8e1140c9e3661df624b9a.jpg"
...
async def tb(event):
    if event.sender_id == OWNER_ID:
        ...
        if sudousers:
            ...
            newsudo = f"{target}"
        await ok.edit(f"**Added `{target}` ** as a sudo user ✔︎ Chal Ab Fatafat LADOO Khilade Beta ")
