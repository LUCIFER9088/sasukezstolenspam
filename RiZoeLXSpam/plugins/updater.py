...
OFFICIAL_UPSTREAM_REPO = "https://github.com/hustlerabhay/sasukezstolenspam"
BOT_IS_UP_TO_DATE = "**SASUKE** is Up-to-Date Sur, Now Gib Party Else Rep."
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog : \n\n{changelog}\n"
    "updating your LUXCLUB SPAMMER SASUKE ..."
)
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        text = "__𝗨𝗽𝗱𝗮𝘁𝗶𝗻𝗴..... 𝗬𝗼𝘂𝗿 𝗟𝗨𝗫𝗖𝗟𝗨𝗕 𝗦𝗣𝗔𝗠𝗠𝗘𝗥 𝗦𝗔𝗦𝗨𝗞𝗘__\n𝗧𝘆𝗽𝗲 .ping 𝗔𝗳𝘁𝗲𝗿 𝗙𝗜𝗩𝗘 𝗺𝗶𝗻𝘀 𝗧𝗼 𝗰𝗵𝗲𝗰𝗸 𝗺𝘆 𝗦𝗵𝗮𝗿𝗶𝗻𝗴𝗮𝗻 !!"
...
async def deploy_start(Riz, message, refspec, remote):
    ...
    await message.edit(
        "Updated your LUXCLUB SPAMMER SASUKE SaxSaxFully, Now Gib A Gulambi"
    )
